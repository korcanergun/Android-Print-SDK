...
import ly.kite.print.payment.PayPalCard;
import ly.kite.print.payment.PayPalCardChargeListener;
import ly.kite.print.payment.PayPalCardVaultStorageListener;
import ly.kite.print.psprintstudio.Analytics;
import ly.kite.print.psprintstudio.FontUtils;
import io.card.payment.CardIOActivity;
import io.card.payment.CreditCard;

public class PaymentActivity extends Activity {

    public static final String EXTRA_PRINT_ORDER = "ly.kite.print.EXTRA_PRINT_ORDER";
    public static final String EXTRA_PRINT_ENVIRONMENT = "ly.kite.print.EXTRA_PRINT_ENVIRONMENT";
    public static final String EXTRA_PRINT_API_KEY = "ly.kite.print.EXTRA_PRINT_API_KEY";

    public static final String ENVIRONMENT_STAGING = "ly.kite.print.ENVIRONMENT_STAGING";
    public static final String ENVIRONMENT_LIVE = "ly.kite.print.ENVIRONMENT_LIVE";
    public static final String ENVIRONMENT_TEST = "ly.kite.print.ENVIRONMENT_TEST";
