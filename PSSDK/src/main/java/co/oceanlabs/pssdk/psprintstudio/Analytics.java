package co.oceanlabs.pssdk.psprintstudio;
...
public class Analytics {
    ...
    private static String getMixpanelToken(PSPrintSDK.Environment env) {
        if (env == PSPrintSDK.Environment.LIVE) {
    ...
    public static void trackShippingDetailsSupplied(Context context, PSPrintSDK.Environment env, PrintOrder order) {
    ...
    public static void trackPaymentCompleted(Context context, PSPrintSDK.Environment env, PrintOrder order) {
    ...
    public static void trackOrderSubmission(Context context, PSPrintSDK.Environment env, PrintOrder order) {
        JSONObject p = getOrderProperties(order);
        MixpanelAPI mixpanel = MixpanelAPI.getInstance(context, getMixpanelToken(env));
